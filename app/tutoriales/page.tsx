...
export default function TutorialesPage() {
  return (
    <AppShell active="play">
      <section className="hero section"><div className="kicker">Videos / demos</div><h1 className="h1">Videos ProKicks</h1><p className="p">Tutoriales y demos ProKicks en preparación. Aquí encontrarás jugadas, reglas, técnicas y mejores momentos.</p></section>
