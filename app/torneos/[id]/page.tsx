...
export default function TournamentDetail(){
  ...
  return <AppShell active="torneos">
    ...
    {item.rules && <section className="card section detail-bottom-safe"><h2 className="card-title">Reglas</h2><p className="p">{item.rules}</p><Link href="/reglamento" className="inline-link">Ver reglamento completo</Link></section>}
  </AppShell>
}
