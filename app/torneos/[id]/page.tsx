...
import { CalendarDays, ClipboardCheck, FileSignature, MapPin, Share2, Trophy, Users } from 'lucide-react';
  ...
  return (
    <AppShell active="torneos">
      <section className="hero section tournament-hero">
        ...
        <button className="btn btn-soft btn-full section" onClick={shareTournament}><Share2 size={16} /> Compartir torneo</button>
